...
export class ProductRepository implements IProductRepository {
  ...
  async findBySku(sku: string): Promise<Product | null> {
    try {
      ...
      throw new DatabaseError("ProductRepository.findBySku", { cause: error, sku });
    }
  }
  ...
  async getStock(sku: string): Promise<number | null> {
    try {
      ...
      throw new DatabaseError("ProductRepository.getStock", { cause: error, sku });
    }
  }
  ...
  async exists(sku: string): Promise<boolean> {
    try {
      ...
      throw new DatabaseError("ProductRepository.exists", { cause: error, sku });
    }
  }
